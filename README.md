...
```console
docker run cisagov/example:0.2.1
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/example:0.2.1
    ```
...
|-----------|-------------|
|`cisagov/example:0.2.1`| An exact release version. |
